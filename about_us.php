...
<head>
    ...
    <title>About us - DMC Bank</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:#212529; padding-top:10%;">
<img src="statics/mountain.jpg" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/abhishek.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Abhishek Jaiswal</h1>
            <p style="color:gray;"><b> Sparks Foundation <br> Thakur College of Engineering and 
            Technology </b></p>
    </center>
