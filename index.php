...
<head>
    ...
    <title>Welcome to DMC Bank</title>
...
<h1 style="color:black; margin-top: 25px;"><b>Please rotate the device. </b><br>This only supports landscape mode.</h1>
</div>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="statics\logo2.png" alt=""
    ...
    <div class="container-large"
        style="color:aqua; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:black;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> DMC
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/banker.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/mountain.jpg" alt="" style="width:100%; position:absolute; z-index:-1">
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:teal; color:white; width: 90%; border-radius:30px; box-shadow:px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <h6>This is the list of customers and their details</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            style="background-color:teal; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6>Here, you can proceed with transaction from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
